<script setup>
/**
 * PageShellSkeleton.vue frontend component.
 *
 * @since 1.4.7
 * @version 1.4.7
 */
  ...
  <div class="joinotify-settings min-h-screen">
    <div class="w-full">
      <div class="flex items-start gap-3 px-10 pt-8">
        <div class="mt-1 flex h-12 w-12 shrink-0 items-center justify-center rounded-lg bg-white text-sm font-semibold text-slate-400 shadow-[0_1px_0_rgba(0,0,0,0.02)] ring-1 ring-slate-200">
          <span>J</span>
        </div>

        <div class="pt-1">
          <div class="h-7 w-[18rem] max-w-[70vw] rounded-full bg-slate-200/80" />
          <div class="mt-4 h-4 w-[34rem] max-w-[70vw] rounded-full bg-slate-200/60" />
        </div>
      </div>
