...
<template>
  ...
  >
    <span class="relative inline-flex h-5 w-5 shrink-0">
      ...
      <span
        aria-hidden="true"
        class="absolute inset-0 rounded-md border border-slate-300 bg-white transition peer-focus-visible:ring-4 peer-focus-visible:ring-primary-100 peer-checked:border-primary-700 peer-checked:bg-primary-700"
      />
      <svg
        aria-hidden="true"
        viewBox="0 0 20 20"
