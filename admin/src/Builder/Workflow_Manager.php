...
class Workflow_Manager {
    ...
    public static function get_start_templates() {
        return apply_filters( 'Joinotify/Builder/Choose_Template', array(
            'scratch' => array(
                'title' => __( 'Start from scratch', 'joinotify' ),
                'description' => __( 'Create your automation workflow from scratch.', 'joinotify' ),
                'button_title' => __( 'Start from scratch', 'joinotify' ),
            ...
            'template' => array(
                'title' => __( 'Start with a template', 'joinotify' ),
                'description' => __( 'Create your automation workflow from a template you choose.', 'joinotify' ),
                'button_title' => __( 'Create from template', 'joinotify' ),
            ...
            'import' => array(
                'title' => __( 'Import a template', 'joinotify' ),
                'description' => __( 'Create your automation workflow by importing a file.', 'joinotify' ),
                'button_title' => __( 'Import file', 'joinotify' ),
