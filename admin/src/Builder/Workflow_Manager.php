...
class Workflow_Manager {
    ...
    public static function get_start_templates() {
        return apply_filters( 'Joinotify/Builder/Choose_Template', array(
            'scratch' => array(
                'title' => esc_html__( 'Start from scratch', 'joinotify' ),
                'description' => esc_html__( 'Create your automation workflow from scratch.', 'joinotify' ),
                'button_title' => esc_html__( 'Start from scratch', 'joinotify' ),
            ...
            'template' => array(
                'title' => esc_html__( 'Start with a template', 'joinotify' ),
                'description' => esc_html__( 'Create your automation workflow from a template you choose.', 'joinotify' ),
                'button_title' => esc_html__( 'Create from template', 'joinotify' ),
            ...
            'import' => array(
                'title' => esc_html__( 'Import a template', 'joinotify' ),
                'description' => esc_html__( 'Create your automation workflow by importing a file.', 'joinotify' ),
                'button_title' => esc_html__( 'Import file', 'joinotify' ),
	...
	public function load_builder_files() {
		?>
        <div id="joinotify-automations-builder">
            <?php
