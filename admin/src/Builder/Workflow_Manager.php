...
class Workflow_Manager {
    ...
    public static function get_start_templates() {
        return apply_filters( 'Joinotify/Builder/Choose_Template', array(
            'scratch' => array(
                'title' => esc_html__( 'Come̤ar do zero', 'joinotify' ),
                'description' => esc_html__( 'Crie seu fluxo de automa̤̣o do zero', 'joinotify' ),
            ...
            'template' => array(
                'title' => esc_html__( 'Come̤ar com um modelo', 'joinotify' ),
                'description' => esc_html__( 'Crie seu fluxo de automa̤̣o a partir de um modelo de sua escolha', 'joinotify' ),
            ...
            'import' => array(
                ...
                'description' => esc_html__( 'Crie seu fluxo de automa̤̣o importando a partir de um arquivo', 'joinotify' ),
