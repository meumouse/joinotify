    ...
    public static function get_all_actions( $context = '' ) {
        $actions = apply_filters( 'Joinotify/Builder/Actions', array(
            array(
                ...
                'description' => esc_html__( 'Permite definir um tempo de espera antes da aÃ§Ã£o ser executada.', 'joinotify' ),
            ...
            array(
                'action' => 'condition',
                'title' => esc_html__( 'CondiÃ§Ã£o', 'joinotify' ),
                'description' => esc_html__( 'Permite definir uma condiÃ§Ã£o para uma aÃ§Ã£o ser executada.', 'joinotify' ),
                'context' => array(), // available for all the contexts
            ...
            array(
                'action' => 'stop_funnel',
                'title' => esc_html__( 'Parar automaÃ§Ã£o aqui', 'joinotify' ),
                'description' => esc_html__( 'Nenhuma aÃ§Ã£o serÃ¡ executada ao chegar nesse ponto.', 'joinotify' ),
                'context' => array(), // available for all the contexts
            ...
            array(
                ...
                'description' => esc_html__( 'Adicione uma funÃ§Ã£o, conjunto de aÃ§Ãµes e ou filtros em PHP.', 'joinotify' ),
                'context' => array(), // available for all the contexts
            ...
            array(
                ...
                'title' => esc_html__( 'VariÃ¡vel de texto dinÃ¢mica', 'joinotify' ),
                'description' => esc_html__( 'Recupere dados de qualquer parte do WordPress via cÃ³digo PHP, acessando objetos, arrays e metadados dinamicamente.', 'joinotify' ),
                'context' => array(), // available for all the contexts
