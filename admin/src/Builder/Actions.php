    ...
    public static function get_all_actions( $context = '' ) {
        $actions = apply_filters( 'Joinotify/Builder/Actions', array(
            ...
            array(
                ...
                'title' => esc_html__( 'Dynamic text variable', 'joinotify' ),
                'description' => esc_html__( 'Retrieve data from anywhere in WordPress via PHP code, dynamically accessing objects, arrays and metadata.', 'joinotify' ),
                'context' => array(), // available for all the contexts
