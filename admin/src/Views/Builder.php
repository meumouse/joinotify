...
$bootstrap = Registry::get_bootstrap_data( $post_id );
$debug_mode = ! empty( $bootstrap['debug_mode'] );
$bootstrap_json = wp_json_encode( $bootstrap, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES ); ?>
...
<div class="wrap p-0 joinotify-builder-page">
	...
	<div id="joinotify-builder-app" class="joinotify-builder-app" data-bootstrap="<?php echo esc_attr( $bootstrap_json ); ?>">
		<style>
			#adminmenumain,
			#wpfooter {
				display: none !important;
		...
		<div class="joinotify-loader-container">
