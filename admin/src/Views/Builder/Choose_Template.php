...
<div id="joinotify_choose_template_container" class="active">
    ...
    <div id="joinotify_template_library_container" class="choose-template-container slide-animation slide-right-animation">
        <div class="mb-4 search-workflows-wrapper">
            <h3 class="title d-flex align-items-center justify-content-center"><?php esc_html_e( 'Start automating your site from a template', 'joinotify' ) ?></h3>
            <span class="d-flex align-items-center justify-content-center mb-lg-3 mb-xxl-5 text-muted"><?php esc_html_e( 'Browse by categories or names.', 'joinotify' ) ?></span>

            <div class="input-group">
                <input id="joinotify_search_workflows" type="text" class="form-control" placeholder="<?php esc_attr_e( 'Search workflows', 'joinotify' ) ?>">
                
                <select id="joinotify_filter_library_categories" class="form-select">
                    <option value="all"><?php esc_html_e( 'All workflows', 'joinotify' ) ?></option>    
    ...
    <div id="joinotify_import_template_container" class="choose-template-container slide-animation slide-right-animation">
        <div class="card p-0 m-0">
            <div class="card-header border-bottom-0 px-4 pt-5">
                <h3 class="title fs-5"><?php esc_html_e( 'Import template', 'joinotify' ) ?></h3>
            ...
            <div class="card-body align-items-start w-100 px-4 mb-3">
                <div class="dropzone mt-4" id="joinotify_import_file_zone">
                    <div class="drag-text">
                        ...
                        <?php esc_html_e( 'Drag and drop the .json file here', 'joinotify' ); ?>
                    </div>
                    ...
                    <div class="drag-and-drop-file">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="upload_template_file"><?php esc_html_e( 'Or click to browse for your file', 'joinotify' ); ?></label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-footer d-flex justify-content-between align-items-center p-4">
                <button type="button" id="joinotify_cancel_import_template" class="btn btn-outline-secondary"><?php esc_html_e( 'Cancel', 'joinotify' ) ?></button>
                <button type="button" id="joinotify_send_import_files" class="btn btn-primary" disabled><?php esc_html_e( 'Import', 'joinotify' ) ?></button>
            </div>
        </div>
    </div>
</div>