...
<div id="joinotify_triggers_group" class="">
    ...
    <div class="triggers-header mb-lg-3 mb-xxl-5">
        <h2 class="sidebar-title fs-5"><?php esc_html_e( 'Choose the trigger type', 'joinotify' ) ?></h2>
...
<div id="joinotify_triggers_content" class="triggers-content-wrapper">
    <div class="triggers-content-container">
        <div class="set-trigger-name d-grid mb-xxl-4 pb-3">
            <h3 class="trigger-name mt-0 mb-lg-2 mb-xxl-3 fs-5"><?php esc_html_e( 'Define a name for this workflow', 'joinotify' ) ?></h3>
        ...
        <div class="mt-lg-2 mt-xxl-4 pt-lg-2 pt-xxl-3 w-100 d-flex align-items-center justify-content-between">
            ...
            <button type="button" id="joinotify_proceed_step_funnel" class="btn btn-lg btn-primary" disabled><?php esc_html_e( 'Continue', 'joinotify' ) ?></button>
        </div>
    </div>
</div>