...
class Settings {
     ...
     * @return string 
     */
    private $inc_directory = JOINOTIFY_SRC;
    ...
    public function register_settings_tabs() {
        return apply_filters( 'Joinotify/Admin/Register_Settings_Tabs', array(
            'general' => array(
                ...
                'file' => $this->inc_directory . 'Views/Settings/Tabs/General.php',
            ),
            'phones' => array(
                'id' => 'phones',
                ...
                'file' => $this->inc_directory . 'Views/Settings/Tabs/Phones.php',
            ),
            'integrations' => array(
                'id' => 'integrations',
                ...
                'file' => $this->inc_directory . 'Views/Settings/Tabs/Integrations.php',
            ),
            'about' => array(
                'id' => 'about',
                ...
                'file' => $this->inc_directory . 'Views/Settings/Tabs/About.php',
            ),
        ));
    }
}
