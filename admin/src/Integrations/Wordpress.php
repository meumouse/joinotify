    ...
    public function add_triggers( $triggers ) {
        $triggers['wordpress'] = array(
            ...
            array(
                ...
                'title' => esc_html__( 'Password reset request', 'joinotify' ),
