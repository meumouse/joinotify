    ...
    public function add_subscription_triggers( $triggers ) {
        $new_triggers = array(
            array(
                ...
                'description' => esc_html__( 'This trigger is fired when a new subscription is created in WooCommerce.', 'joinotify' ),
                'require_settings' => false,
            ),
            array(
                'data_trigger' => 'woocommerce_subscription_status_active',
                'title' => esc_html__( 'Subscription is activated', 'joinotify' ),
                'description' => esc_html__( 'This trigger is fired when a subscription status changes to active.', 'joinotify' ),
                'require_settings' => false,
            ),
            array(
                'data_trigger' => 'woocommerce_subscription_payment_complete',
                'title' => esc_html__( 'Renewal payment received', 'joinotify' ),
                'description' => esc_html__( 'This trigger is fired when a recurring subscription payment is received.', 'joinotify' ),
                'require_settings' => false,
            ),
            array(
                'data_trigger' => 'woocommerce_subscription_payment_failed',
                'title' => esc_html__( 'Renewal payment failed', 'joinotify' ),
                'description' => esc_html__( 'This trigger is fired when a recurring subscription payment fails or is declined.', 'joinotify' ),
                'require_settings' => false,
            ),
            array(
                'data_trigger' => 'woocommerce_subscription_status_expired',
                'title' => esc_html__( 'Subscription renewal expired', 'joinotify' ),
                'description' => esc_html__( 'This trigger is fired when a subscription term has expired.', 'joinotify' ),
                'require_settings' => false,
            ),
            array(
                'data_trigger' => 'woocommerce_subscription_status_cancelled',
                'title' => esc_html__( 'Subscription canceled', 'joinotify' ),
                'description' => esc_html__( 'This trigger is fired when the subscription status changes to canceled.', 'joinotify' ),
                'require_settings' => false,
            ),
        );
