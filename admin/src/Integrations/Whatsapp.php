...
class Whatsapp extends Integrations_Base {
    ...
    public function __construct() {
        ...
        if ( Admin::get_setting('enable_whatsapp_integration') === 'yes' ) {
            ...
            add_filter( 'Joinotify/Builder/Action_Categories', array( $this, 'add_messaging_category' ), 10, 1 );
        }
    }
     ...
     * @return array
     */
    public function add_messaging_category( $categories ) {
        $categories[] = array(
            'id' => 'messaging',
            'label' => esc_html__( 'Messages', 'joinotify' ),
            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4c-1.103 0-2 .897-2 2v18l5.333-4H20c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2zm0 14H6.667L4 18V4h16v12z"></path></svg>',
            'priority' => 20,
        );
