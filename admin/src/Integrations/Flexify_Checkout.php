...
class Flexify_Checkout extends Integrations_Base {
    ...
    public function __construct() {
        ...
        add_filter( 'Joinotify/Settings/Tabs/Integrations', array( $this, 'add_integration_item' ), 30, 1 );
    ...
    public function add_integration_item( $integrations ) {
        $integrations['flexify_checkout'] = array(
            'title' => esc_html__('Flexify Checkout for WooCommerce', 'joinotify'),
            'description' => esc_html__('Recupere vendas nÃ£o finalizadas, envie o cÃ³digo Pix no WhatsApp e otimize a finalizaÃ§Ã£o de compras, garantindo mais conversÃµes.', 'joinotify'),
    ...
    public function add_triggers( $triggers ) {
        $fcrc_plugin = array(
            'name' => esc_html__( 'Flexify Checkout - RecuperaÃ§Ã£o de carrinhos abandonados', 'joinotify' ),
        ...
        $triggers['flexify_checkout'] = array(
            array(
                ...
                'description' => esc_html__( 'Este acionamento Ã© disparado quando o usuÃ¡rio fornece seus dados de contato via modal.', 'joinotify' ),
            ...
            array(
                ...
                'description' => esc_html__( 'Este acionamento Ã© disparado quando o usuÃ¡rio fornece seus dados de contato pelo checkout.', 'joinotify' ),
                'require_settings' => false,
                'require_plugins' => true,
                'plugins' => array(
                    $fcrc_plugin,
            ...
            array(
                ...
                'description' => esc_html__( 'Este acionamento Ã© disparado quando o usuÃ¡rio abandona o carrinho.', 'joinotify' ),
                'require_settings' => false,
                'require_plugins' => true,
                'plugins' => array(
                    $fcrc_plugin,
            ...
            array(
                ...
                'title' => esc_html__( 'Carrinho abandonado Ã© recuperado', 'joinotify' ),
                'description' => esc_html__( 'Este acionamento Ã© disparado quando um carrinho abandonado Ã© recuperado.', 'joinotify' ),
                'require_settings' => false,
                'require_plugins' => true,
                'plugins' => array(
                    $fcrc_plugin,
            ...
            array(
                ...
                'description' => esc_html__( 'Este acionamento Ã© disparado quando um pedido Ã© abandonado.', 'joinotify' ),
                'require_settings' => false,
                'require_plugins' => true,
                'plugins' => array(
                    $fcrc_plugin,
            ...
            array(
                ...
                'description' => esc_html__( 'Este acionamento Ã© disparado quando um carrinho Ã© considerado perdido.', 'joinotify' ),
                'require_settings' => false,
                'require_plugins' => true,
                'plugins' => array(
                    $fcrc_plugin,
        ...
        if ( class_exists('Module_Inter_Bank') ) {
            $inter_placeholders = array(
                '{{ fc_inter_pix_copia_cola }}' => array(
                    ...
                    'description' => esc_html__( 'Para recuperar o cÃ³digo Pix Copia e Cola do pedido. AtravÃ©s da integraÃ§Ã£o Flexify Checkout - Inter addon', 'joinotify' ),
                    'replacement' => array(
                ...
                '{{ fc_inter_pix_expiration_time }}' => array(
                    'triggers' => $trigger_names,
                    'description' => esc_html__( 'Para recuperar o tempo de expiraÃ§Ã£o do Pix Copia e Cola. AtravÃ©s da integraÃ§Ã£o Flexify Checkout - Inter addon', 'joinotify' ),
                    'replacement' => array(
        ...
        if ( class_exists('Flexify_Checkout_Recovery_Carts') ) {
            ...
            $placeholders['flexify_checkout'] = array(
                ...
                '{{ fcrc_last_name }}' => array(
                    'triggers' => $fcrc_triggers,
                    'description' => esc_html__( "Retrieve the cart contact's last name.", 'joinotify' ),
                    'replacement' => array(
                ...
                '{{ fcrc_phone }}' => array(
                    'triggers' => $fcrc_triggers,
                    'description' => esc_html__( "Retrieve the cart contact's phone number.", 'joinotify' ),
                    'replacement' => array(
                ...
                '{{ fcrc_recovery_link }}' => array(
                    'triggers' => $fcrc_triggers,
                    'description' => esc_html__( 'Link de recuperaÃ§Ã£o do carrinho abandonado.', 'joinotify' ),
                    'replacement' => array(
                ...
                '{{ fcrc_cart_total }}' => array(
                    'triggers' => $fcrc_triggers,
                    'description' => esc_html__( 'Retrieve the cart total amount.', 'joinotify' ),
                    'replacement' => array(
    ...
    public function add_conditions( $conditions ) {
        $fc_conditions = array(
            'Flexify_Checkout/Recovery_Carts/Cart_Abandoned' => array(
                'cart_total' => array(
                    'title' => __( 'Cart total', 'joinotify' ),
                    'description' => __( 'Allows checking the abandoned cart total amount.', 'joinotify' ),
                ),
                'items_in_cart' => array(
                    'title' => __( 'Cart items', 'joinotify' ),
                ...
                'cart_recovered' => array(
                    ...
                    'description' => __( 'Allows checking whether the abandoned cart was recovered.', 'joinotify' ),
                ),
            ),
        );
