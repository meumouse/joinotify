...
class Wpforms extends Integrations_Base {
    ...
    public function add_integration_item( $integrations ) {
        $integrations['wpforms'] = array(
            ...
            'description' => esc_html__('Automate sending messages when you receive a WPForms form with a phone number. Keep your customers informed in real time.', 'joinotify'),
