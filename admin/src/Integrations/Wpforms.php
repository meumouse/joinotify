...
class Wpforms extends Integrations_Base {
    ...
    public function add_integration_item( $integrations ) {
        $integrations['wpforms'] = array(
            ...
            'description' => __('Automate sending messages when you receive a WPForms form with a phone number. Keep your customers informed in real time.', 'joinotify'),
            'category' => 'forms',
    ...
    public function add_triggers( $triggers ) {
        $triggers['wpforms'] = array(
            array(
                ...
                'title' => __( 'Form is sent', 'joinotify' ),
                'description' => __( 'This trigger fires when a WPForms form is submitted.', 'joinotify' ),
                'require_settings' => true,
            ),
            array(
                'data_trigger' => 'wpforms_paypal_standard_process_complete',
                'title' => __( 'Payment processed by PayPal', 'joinotify' ),
                'description' => __( 'This trigger fires when a WPForms payment form is processed using PayPal.', 'joinotify' ),
                'require_settings' => true,
            ),
        );
    ...
    public function add_triggers_tab() {
        ...
        $integration_name = __( 'WPForms', 'joinotify' );
    ...
    public function add_placeholders( $placeholders ) {
        $placeholders['wpforms'] = array(
            '{{ field_id=[FIELD_ID] }}' => array(
                ...
                'description' => __( 'To retrieve information from a WPForms form field. Replace FIELD_ID with the corresponding field ID.', 'joinotify' ),
    ...
    public function add_conditions( $conditions ) {
        ...
        $common_conditions = array(
            'field_value' => array(
                'title' => __( 'Form field value', 'joinotify' ),
                'description' => __( 'Allows checking a specific value from a submitted form field.', 'joinotify' ),
            ),
            'user_meta' => array(
