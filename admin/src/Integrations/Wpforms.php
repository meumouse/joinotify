...
class Wpforms extends Integrations_Base {
    ...
    public function add_integration_item( $integrations ) {
        $integrations['wpforms'] = array(
            ...
            'description' => esc_html__('Automatize o envio de mensagens ao receber um formulÃ¡rio WPForms com telefone. Mantenha seus clientes informados em tempo real.', 'joinotify'),
    ...
    public function add_triggers( $triggers ) {
        $triggers['wpforms'] = array(
            ...
            array(
                ...
                'title' => esc_html__( 'Payment processed by PayPal', 'joinotify' ),
                'description' => esc_html__( 'This trigger fires when a WPForms payment form is processed using PayPal.', 'joinotify' ),
                'require_settings' => true,
            ),
        );
    ...
    public function add_placeholders( $placeholders ) {
        $placeholders['wpforms'] = array(
            '{{ field_id=[FIELD_ID] }}' => array(
                ...
                'description' => esc_html__( 'To retrieve information from a WPForms form field. Replace FIELD_ID with the corresponding field ID.', 'joinotify' ),
