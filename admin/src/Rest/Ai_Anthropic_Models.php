...
/**
 * Return the Anthropic model list for the settings dropdown.
 *
 * Supports a `refresh` flag to bypass the cache and fetch a fresh list from the
 * Anthropic API so newly released models become available on demand.
 *
 * @since 2.1.0
 * @package MeuMouse\Joinotify\Rest
 * @author MeuMouse.com
 */
class Ai_Anthropic_Models extends Abstract_Route {
     ...
     * @var string
     */
    protected $route = '/admin/ai/anthropic-models';
