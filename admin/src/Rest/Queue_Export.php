...
/**
 * Export pending scheduled items (by ID, or all matching the filters) as a JSON file.
 *
 * @since 2.4.2
 */
class Queue_Export extends Abstract_Route {
	 ...
	 * @var string
	 */
	protected $route = '/admin/queue/export';
