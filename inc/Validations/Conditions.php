...
class Conditions {
    ...
    public static function get_conditions_by_trigger( $trigger ) {
        ...
        switch ( $trigger ) {
            ...
            case 'elementor_pro/forms/form_submitted':
                $conditions = array(
                    'form_id' => array(
    ...
    /**
     * Get specific placeholders for each trigger
     *
     * @since 1.0.0
     * @return array Associative array of triggers and their placeholders
     */
    public static function get_conditional_placeholders() {
        return apply_filters( 'Joinotify/Validations/Get_Conditional_Placeholders', array(
            'user_register' => array(
                '{{ first_name }}',
                '{{ last_name }}',
                '{{ phone }}',
            ...
            'wpforms_paypal_standard_process_complete' => array(
                '{{ first_name }}',
                '{{ last_name }}',
                '{{ phone }}',
                '{{ email }}',
            ),
            'elementor_pro/forms/form_submitted' => array(
                '{{ first_name }}',
                '{{ last_name }}',
                '{{ phone }}',
                '{{ email }}',
