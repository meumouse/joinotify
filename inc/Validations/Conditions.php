...
class Conditions {
    ...
    public static function check_condition( $condition, $value, $value_compare = '', $payload = array() ) {
        ...
        // Check if the value is a boolean and the value_compare is a string
        if ( is_bool( $value ) && is_string( $value_compare ) ) {
            $value_compare = filter_var( $value_compare, FILTER_VALIDATE_BOOLEAN, FILTER_NULL_ON_FAILURE );
        }
