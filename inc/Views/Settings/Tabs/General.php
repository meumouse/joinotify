...
<div id="general" class="nav-content">
    <table class="form-table">
        <tbody>
            ...
            <tr>
                <th>
                    <?php esc_html_e( 'Ativar dicas visuais no construtor de fluxos', 'joinotify' ); ?>
                    <span class="joinotify-description"><?php esc_html_e( 'Ative essa opção para exibir dicas de como utilizar o construtor de fluxos.', 'joinotify' ); ?></span>
                </th>
                <td>
                    <div class="form-check form-switch">
                        <input type="checkbox" class="toggle-switch" id="enable_visual_tour" name="enable_visual_tour" value="yes" <?php checked( Admin::get_setting('enable_visual_tour') === 'yes' ); ?> />
                    </div>
                </td>
            </tr>
