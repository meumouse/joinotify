...
<div id="joinotify_triggers_group" class="">
    ...
    <div class="triggers-header mb-5">
...
<div id="joinotify_triggers_content" class="triggers-content-wrapper">
    <div class="triggers-content-container">
        <div class="set-trigger-name d-grid mb-4 pb-3">
            <h3 class="trigger-name mt-0 mb-3 fs-5"><?php esc_html_e( 'Defina um nome para este fluxo', 'joinotify' ) ?></h3>
            <span class="description mb-4 text-muted fs-6"><?php esc_html_e( 'O nome servirá para controle interno desse fluxo', 'joinotify' ) ?></span>
        ...
        <div class="mt-4 pt-3 w-100 d-flex align-items-center justify-content-between">
