...
<div id="joinotify_actions_group" class="">
    ...
    <div class="actions-body">
        <div class="actions-wrapper">
            <?php foreach ( Core::get_all_actions() as $action ) : ?>
                ...
                <div class="offcanvas offcanvas-end" data-action="<?php esc_attr_e( $action['action'] ) ?>" data-bs-scroll="false" data-bs-backdrop="false" tabindex="-1" id="offcanvas_<?php esc_attr_e( $action['action'] ) ?>" aria-labelledby="offcanvas_<?php esc_attr_e( $action['action'] ) ?>_label">
                    <div class="offcanvas-header p-4 mt-2 border-bottom">
                        <?php if ( ! $action['external_icon'] ) : ?>
                            <div class="action-item-icon me-3"><?php echo $action['icon'] ?></div>
                        <?php endif; ?>
                    ...
                    <div class="offcanvas-body p-4 py-5">
                        ...
                        <?php elseif ( $action['action'] === 'send_whatsapp_message_text' ) : ?>
                            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                <?php printf( __( '<strong>Dica: </strong> Você pode deixar textos em negrito, sublinhados, ou riscados com variáveis do WhatsApp. Veja mais detalhes na <a href="%s" class="alert-link" target="_blank">documentação do Joinotify</a>.', 'joinotify' ), JOINOTIFY_DOCS_URL ); ?>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="joinotify_get_whatsapp_number_msg_text" type="text" class="form-control" value="{{ phone }}" placeholder="<?php esc_attr_e( '+5541987111527', 'joinotify' ) ?>"/>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" id="joinotify_get_whatsapp_message_text" class="form-control set-whatsapp-message set-whatsapp-message-text" placeholder="<?php esc_attr_e( 'Mensagem', 'joinotify' ) ?>"/>
                            </div>
                        ...
                        <?php elseif ( $action['action'] === 'send_whatsapp_message_media' ) : ?>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="joinotify_get_whatsapp_number_msg_media" type="text" class="form-control" value="{{ phone }}" placeholder="<?php esc_attr_e( '+5541987111527', 'joinotify' ) ?>"/>
                            </div>
