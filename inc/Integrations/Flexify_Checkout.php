...
class Flexify_Checkout extends Integrations_Base {
    ...
    public function add_integration_item( $integrations ) {
        $integrations['flexify_checkout'] = array(
            'title' => esc_html__('Flexify Checkout para WooCommerce', 'joinotify'),
            'description' => esc_html__('Recupere vendas não finalizadas, envie o código Pix no WhatsApp e otimize a finalização de compras, garantindo mais conversões.', 'joinotify'),
