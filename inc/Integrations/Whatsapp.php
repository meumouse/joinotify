...
class Whatsapp extends Integrations_Base {
    ...
    public function add_whatsapp_messages( $actions ) {
        $actions[] = array(
            ...
            'external_icon' => false,
            'has_settings' => true,
            'settings' => self::whatsapp_message_text_action_settings(),
            'priority' => 40,
            'is_expansible' => true,
        );
        ...
        $actions[] = array(
            ...
            'external_icon' => false,
            'has_settings' => true,
            'settings' => self::whatsapp_message_media_action_settings(),
            'priority' => 50,
            'is_expansible' => false,
        );
    ...
    /**
     * Render WhatsApp message text settings on sidebar action
     * 
     * @since 1.1.0
     * @return string
     */
    public static function whatsapp_message_text_action_settings() {
        ob_start();
    ...
    /**
     * Render WhatsApp message media settings on sidebar action
     * 
     * @since 1.1.0
     * @return string
     */
    public static function whatsapp_message_media_action_settings() {
        ob_start(); ?>
