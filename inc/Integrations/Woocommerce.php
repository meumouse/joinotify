...
class Woocommerce extends Integrations_Base {
    ...
    public function __construct() {
        ...
        if ( class_exists('WooCommerce') ) {
            ...
            add_filter( 'Joinotify/Builder/Placeholders_List', array( $this, 'add_woocommerce_placeholders' ), 10, 2 );
    ...
    public function add_woocommerce_tab_content() {
        if ( Admin::get_setting('enable_woocommerce_integration') === 'yes' ) : ?>
            <div id="woocommerce" class="nav-content triggers-group">
                <?php foreach ( Triggers::get_triggers_by_context('woocommerce') as $trigger ) : ?>
     ...
     * @return array
     */
    public function add_woocommerce_placeholders( $placeholders, $context ) {
        ...
        $placeholders['woocommerce'] = array(
            '{{ wc_billing_first_name }}' => array(
                'triggers' => Triggers::get_triggers_by_context('woocommerce'),
